# Story 3 — Single Event Ingest (`POST /v1/events`)

> **Phase:** 0 — Core Event Ingestion Pipeline
> **Depends on:** Story 1 (domain types), Story 2 (auth middleware, `GetKeyContext`)
> **Blocks:** Story 4 (batch shares validation + Kafka patterns)
